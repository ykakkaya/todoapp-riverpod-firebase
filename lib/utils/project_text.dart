class ProjectText {
  static final String greating = 'Merhaba';
  static final String today = 'Bugünün Tarihi';
  static final String newTask = 'Yeni Görev Ekle';

  //input field labels
  static final String taskNameLabel = 'Görev Adı';
